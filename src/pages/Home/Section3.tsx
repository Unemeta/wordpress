        ...
        /> */}
          ...
          <ul className="flex flex-wrap  justify-center text-sm mb-10 relative">
            <li className="w-[90%] md:w-96 mb-6 md:mb-0 bg-white md:mr-2 p-5 rounded-lg shadow-md relative">
              ...
              />
              <h4 className="font-bold md:text-lg mb-4 md:mb-8">
                All Protocol
              </h4>
              <p className="mb-8">
                OOFP will start with the BRC20 protocol as a foundation and
                extend its services to various protocol layers within the
                Bitcoin ecosystem.
              </p>
              <p className="bg-[#F2ECF5] rounded-md p-3 text-[#6F49C5]">
                This expansion will enable a broader range of assets to benefit
                from the value-added services provided by OOFP.
              </p>
            </li>
            <li className="w-[90%] md:w-96 bg-white md:ml-2 p-5 rounded-lg shadow-md relative">
              ...
              <p className="mb-8">
                OOFP will include assets such as inscriptions, runes,
                non-fungible tokens (NFTs), and other digital assets.
              </p>
              <p className="bg-[#FFEDC0] rounded-md p-3 text-[#A17533]">
                OOFP seeks to elevate the value and unlock the growth potential
                of these assets within the ecosystem.
              </p>
            </li>
          </ul>
          <div>
